...
BaseSearchPage::BaseSearchPage(QWidget* parent)
    : BaseTablePage(parent), modeCombo(new QComboBox(this)), searchEdit(new QLineEdit(this)), addButton(new QPushButton("Добавить", this)) {
...
void BaseSearchPage::setInitialFilter(const QString& text) const { searchEdit->setText(text); }
