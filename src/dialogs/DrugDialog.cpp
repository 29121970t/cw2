...
void DrugDialog::onAccept() {
    if (eTrade->text().trimmed().isEmpty() || eMedical->text().trimmed().isEmpty() || eManufacturer->text().trimmed().isEmpty() ||
        eForm->text().trimmed().isEmpty() || eCountry->text().trimmed().isEmpty()) {
